          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: ResponsiveMetrics.of(context).h(3)),
                    Text(
                      subtitle,
                      maxLines: 2,
                      overflow: TextOverflow.ellipsis,
              ...
              IconButton(
                ...
                constraints: BoxConstraints.tightFor(width: ResponsiveMetrics.of(context).size(28), height: ResponsiveMetrics.of(context).h(28)),
                iconSize: ResponsiveMetrics.of(context).size(18),
                icon: const Icon(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
            padding: EdgeInsets.symmetric(horizontal: ResponsiveMetrics.of(context).spacing(9), vertical: ResponsiveMetrics.of(context).h(3)),
            decoration: BoxDecoration(
