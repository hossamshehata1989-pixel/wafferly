...
import '../../theme/manage_palette.dart';
...
class _ManageScreenState extends State<ManageScreen> {
  ...
  Widget build(BuildContext context) {
    final palette = context.managePalette;
    final scheme = Theme.of(context).colorScheme;
                ...
                slivers: [
                  SliverPadding(
                    padding: EdgeInsets.fromLTRB(
                      ResponsiveMetrics.of(context).spacing(14),
                      ResponsiveMetrics.of(context).h(7),
                      ResponsiveMetrics.of(context).spacing(14),
                      ResponsiveMetrics.of(context).h(22),
                    ),
                    sliver: SliverList(
                      delegate: SliverChildListDelegate([
                        ...
                        Builder(
                          builder: (context) {
                            final debts = _SystemCard(
                              ...
                              title: 'Debts',
                              subtitle:
                                  'Loans, credit cards and borrowed money.',
                              onTap: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                              ...
                              firstColor: palette.priorityCritical,
                              secondColor: palette.priorityWarning,
                              thirdColor: palette.priorityPositive,
                            ...
                            final recurring = _SystemCard(
                              ...
                              title: 'Recurring',
                              subtitle:
                                  'Bills, subscriptions and recurring income.',
                              onTap: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (_) => const DebtsScreen(),
                            ...
                            return Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  width: ResponsiveMetrics.of(context)
                                      .spacing(8),
                                ),
                        ...
                        _WideSystemCard(
                          ...
                          title: 'Goals',
                          subtitle:
                              'Track your goals and achieve what matters.',
                          metric: '${data.goalCount}',
                          metricLabel: 'active',
                          secondaryMetric:
                              _formatMoneyMinor(data.goalProgressTotal),
                        ...
                        _WideSystemCard(
                          color: palette.budgets,
                          icon: Icons.pie_chart_rounded,
                          title: 'Budgets',
                          subtitle:
                              'Set limits and control your spending.',
...
class _ManageDataLoader {
  ...
  Future<_ManageData> load() async {
    ...
    final availableToSpendMinor =
        (totalAvailableAfterReservationsMinor - commitmentTotalMinor)
            .clamp(0, 1 << 62);
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        Material(
          color: context.managePalette.panelSurface,
...
class _FinancialOverviewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _Panel(
      borderColor: palette.overviewBorder,
      child: Column(
        children: [
          LayoutBuilder(
          ...
          SizedBox(height: metrics.h(10)),
          Divider(
              color: scheme.onSurface.withOpacity(.07),
              height: metrics.h(1)),
            ...
            builder: (context, constraints) {
              ...
              final overviewMetrics = [
                _OverviewMetric(
                  ...
                  color: palette.overviewTotalCommitments,
                ...
                _OverviewMetric(
                  icon: Icons.account_balance_wallet_rounded,
                  color: palette.overviewTotalBalance,
                  title: 'Total Balance',
                ...
                _OverviewMetric(
                  ...
                  color: palette.overviewAvailableToSpend,
              ...
              return Row(
                children: [
                  Icon(
                    ...
                    color: palette.overviewUpcomingDue,
...
class _DueMiniCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      constraints: BoxConstraints(minHeight: metrics.h(58)),
      padding: EdgeInsets.symmetric(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: metrics.h(compact ? 3 : 5)),
          FittedBox(
          ...
          SizedBox(height: metrics.h(compact ? 2 : 4)),
          Text(
            subtitle,
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
                ...
                return Row(
                  children: [
                    ...
                    Container(
                      ...
                      height: metrics.h(62),
                      color: scheme.onSurface.withOpacity(.14),
                    ),
...
class _PriorityBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ConstrainedBox(
      constraints: BoxConstraints(minHeight: metrics.h(62)),
      child: Padding(
        padding: EdgeInsets.fromLTRB(
          metrics.spacing(7),
          metrics.h(7),
...
class _Panel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: padding,
      decoration: BoxDecoration(
        color: palette.panelSurface.withValues(alpha: .94),
...
class _ErrorState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: Padding(
        padding: EdgeInsets.all(metrics.spacing(28)),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Icon(
