...
extension AccountTypeExtension on AccountType {
  String get string {
    switch (this) {
      ...
      case AccountType.debt: return 'debt';
      case AccountType.loan: return 'loan';
      case AccountType.creditCard: return 'creditCard';
      case AccountType.installment: return 'installment';
      ...
      case AccountType.lent: return 'lent';
  ...
  static AccountType fromString(String value) {
    switch (value) {
      ...
      case 'debt': return AccountType.debt;
      case 'loan': return AccountType.loan;
      case 'creditCard': return AccountType.creditCard;
      case 'installment': return AccountType.installment;
      ...
      case 'lent': return AccountType.lent;
